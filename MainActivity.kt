...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Sample Podcast 2.0 feed URL (replace with any feed)
                ...
                when (eventType) {
                    XmlPullParser.START_TAG -> {
                        when (parser.name) {
                            ...
                            "podcast:chapters" -> {
                                // For simplicity, just read chapter titles as string list
                                // Podcast 2.0 chapters are usually in a separate file; skipping for minimal demo
                            }
                        }
                    }
